...
Write-Host "
 ...
 ________  _____  ____  ____  ______   ________  ____   ____   ______   
|_   __  ||_   _||_  _||_  _||_   _ `.|_   __  ||_  _| |_  _|.' ____ \  
  | |_ \_|  | |    \ \  / /    | | `. \ | |_ \_|  \ \   / /  | (___ \_| 
  |  _|     | |     > `' <     | |  | | |  _| _    \ \ / /    _.____`.  
 _| |_     _| |_  _/ /'`\ \_  _| |_.' /_| |__/ |    \ ' /    | \____) | 
|_____|   |_____||____||____||______.'|________|     \_/      \______.' 
  A FIXDEVS APENAS REPASSA O SCRIPT PARA TODOS, CREDITOS AOS CRIADORES!                                                                        

 -------------------------------------------------------------

" -ForegroundColor blue
Write-Host "Oi aguarde um momento, Windows ToolBox vai iniciando..." -ForegroundColor blue
...
$labelSystemTweaks = New-Object 'System.Window.Forms.Label'
	...
	$labelSystemTweaks.Text = 'Ajustes de sistema'
...
$buttonRemoveMSStore.Add_Click({
    ...
    Write-Host "Removendo Microsoft Store"
